<template>
      <div v-if="showGlow" class="glow z-[999]"></div>
      <div
        class="particles z-[999]"
        :style="{ top: particlesTop, left: particlesLeft }"
      >
        <div
          v-for="n in 5"
          :key="n"
  ...
  const randomStyle = (index) => {
    ...
    const duration = rand(3, 6).toFixed(2)
  ...
  .glow {
    ...
    pointer-events: none;
    box-shadow:
      0 0 120px 40px #00ffcc,
      0 0 220px 80px #00ffcc,
      0 0 300px 120px #00ffcc;
  ...
  @keyframes glow {
    ...
    to {
      box-shadow: 0 0 100px 50px #00ffcc;
    }
  }
  </style>
